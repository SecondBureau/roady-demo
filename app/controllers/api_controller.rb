class ApiController < ApplicationController
  def show
    if is_from_invited?
      invitation_type = signed_in? ? :invite_registered_bonus : :invite_unregister_bonus
      User.callback_invitee!(invitation_type , params[:uid] , params[:ec]) if is_first_time_invited?
      mark_session
